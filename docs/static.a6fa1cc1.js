...
var _Landscape = __webpack_require__(35);
...
var _expiredStorage = __webpack_require__(37);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          posts.map(function (post) {
            return _react2.default.createElement(
              'li',
              { key: post.slug, className: 'list-projects__item' },
              _react2.default.createElement(
                _reactStatic.Link,
                { to: '/blog/' + post.slug + '/' },
                post.title
              ...
              _react2.default.createElement(
                'span',
                { className: 'list-projects--date' },
                new _moment2.default(post.date).fromNow()
              ),
              _react2.default.createElement(
                'p',
                null,
...
exports.default = (0, _reactStatic.withRouteData)(Blog);
...
var Post = function (_Component) {
  ...
  _createClass(Post, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _Layout2.default,
        { bg: bg, head: { title: title, description: description } },
        _react2.default.createElement(
          'article',
          { itemScope: true, itemType: 'http://schema.org/Article', itemProp: 'mainEntityOfPage', className: 'blog__post' },
          _react2.default.createElement('meta', { itemProp: 'url', content: url }),
          _react2.default.createElement('meta', { itemProp: 'image', content: bg.toString() }),
          _react2.default.createElement(
            'h1',
            { itemProp: 'name headline' },
            title
          ),
          post.date && _react2.default.createElement(
            'span',
            { className: 'blog__post--date' },
            new _moment2.default(post.date).format('MMM Do, YYYY')
          ),
          _react2.default.createElement('hr', null),
          _react2.default.createElement(
            'section',
...
var _structureData = __webpack_require__(29);

var _structureData2 = _interopRequireDefault(_structureData);
...
var Head = function (_Component) {
  ...
  _createClass(Head, [{
    ...
    value: function render() {
      ...
      var data = JSON.stringify(_structureData2.default);
...
var Navigation = function (_Component) {
  ...
  function Navigation(props) {
    ...
    _this.handleOverflowBody = _this.handleOverflowBody.bind(_this);
  ...
  _createClass(Navigation, [{
    key: 'handleOverflowBody',
    value: function handleOverflowBody() {
      if (typeof document !== 'undefined') {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'nav',
        { ref: this.navigation, role: 'navigation', className: 'navigation ' + (this.state.open && 'navigation--open'),
          itemScope: true, itemType: 'https://schema.org/SiteNavigationElement' },
        _react2.default.createElement(
          'svg',
          { width: '16', height: '14', className: 'navigation--button', onClick: this.handleMobileClick },
          _react2.default.createElement('path', { d: 'M12 6v2H0V6zm4-6v2H0V0zm0 12v2H0v-2z', fill: 'currentColor', fillRule: 'evenodd' })
        ),
        _react2.default.createElement(
...
var _Networks = __webpack_require__(34);
